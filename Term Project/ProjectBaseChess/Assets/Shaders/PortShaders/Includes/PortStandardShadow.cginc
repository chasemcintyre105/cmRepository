...
//#if defined(_ALPHATEST_ON) || defined(_ALPHABLEND_ON) || defined(_ALPHAPREMULTIPLY_ON) || defined(_DISSOLVE) || defined(_REVERSEDISSOLVE)
	...
	) : SV_Target
{
		...
		if(_DissolveMode == 1)
		{
			clip(tex2D(_DissolveMask, i.tex.xy).r - _Dissolve);
		}
		else if( _DissolveMode == 2)
		{
			clip((1 - tex2D(_DissolveMask, i.tex.xy).r) - (1-_Dissolve));
		}
