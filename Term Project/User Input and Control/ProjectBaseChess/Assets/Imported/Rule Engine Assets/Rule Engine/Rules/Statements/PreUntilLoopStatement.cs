...
namespace RuleEngine {
	...
	public class PreUntilLoopStatement : BlockContainingStatement {
        
		public PreUntilLoopStatement(Engine E) : base(E) {
		...
		public PreUntilLoopStatement(Engine E, bool clean) : base(E) {
			ArgumentList.SetArgument(0, NullValue.Instance.NewRef());
			ArgumentList.SetArgument(1, E.IntegerObjectRegistry.CreateIntegerNumberValueFromInt_TS(10));
