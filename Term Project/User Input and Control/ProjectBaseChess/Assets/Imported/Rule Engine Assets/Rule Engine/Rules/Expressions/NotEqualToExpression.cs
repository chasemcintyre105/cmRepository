...
namespace RuleEngine {
	...
	public class NotEqualToExpression : Expression {
		...
		public NotEqualToExpression(Engine E) : base(E) {
			FillArgumentsWithNullValues();
		}
		
		public override void DefineArguments() {
            ArgumentList.DefineArgument("Left", typeof(Value), "If this is the same as the right hand side, this statement will give false. Otherwise true.", false);
            ArgumentList.DefineArgument("Right", typeof(Value), "If this is the same as the left hand side, this statement will give false. Otherwise true.", false);
        }
		...
		public override string GetDescription() {
			return "Determines if two things are not equal.";
		}
